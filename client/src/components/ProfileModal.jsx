...
<div>
    <label className='block text-sm font-medium text-gray-700 mb-1' >
        ...
        <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter short bio' 
...
hover:to-purple-700 transition cursor-pointer'>Save Change</button>
</div>
