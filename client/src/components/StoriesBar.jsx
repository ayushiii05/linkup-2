...
const StoriesBar = () => {
    ...
    const [viewStory, setViewStory] = useState(null); // story object or null
    ...
    return (
     ...
     hover:opacity-80'/> :
            ...
            {/* gradient overlays create stry model */}

            {showModal && <StoryModel setShowModal={setShowModal} fetchStories={fetchStories} />}
            {/*view story model */}
            {viewStory && <StoryViewer viewStory={viewStory} setViewStory={setViewStory} onStoryDeleted={fetchStories} />}
