...
const [likes] = React.useState(post.likes_count);
...
<img src= {img} key={index} className= {`w-full h-48 object-cover rounded-lg ${post.image_urls.length === 1
     && 'col-span-2 h-auto'}`} alt=""/>))}
</div>
{/* post actions */}
